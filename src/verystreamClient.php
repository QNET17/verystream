...
namespace ainzz\verystream;

use GuzzleHttp\Client;
use ainzz\verystream\Builder\AccountInfoBuilder;
use ainzz\verystream\Builder\ContentBuilder;
use ainzz\verystream\Builder\ConversionStatusBuilder;
use ainzz\verystream\Builder\FileInfoBuilder;
use ainzz\verystream\Builder\LinkBuilder;
use ainzz\verystream\Builder\RemoteUploadBuilder;
use ainzz\verystream\Builder\TicketBuilder;
use ainzz\verystream\Entity\AbstractContent;
use ainzz\verystream\Entity\AccountInfo;
use ainzz\verystream\Entity\ConversionStatus;
use ainzz\verystream\Entity\DownloadLink;
use ainzz\verystream\Entity\File;
use ainzz\verystream\Entity\FileInfo;
use ainzz\verystream\Entity\Folder;
use ainzz\verystream\Entity\RemoteUpload;
use ainzz\verystream\Entity\RemoteUploadStatus;
use ainzz\verystream\Entity\Ticket;
use ainzz\verystream\Entity\UploadLink;
use ainzz\verystream\Exception\BadRequestException;
use ainzz\verystream\Exception\BandwidthUsageExceededException;
use ainzz\verystream\Exception\FileNotFoundException;
use ainzz\verystream\Exception\PermissionDeniedException;
use ainzz\verystream\Exception\ServerException;
use ainzz\verystream\Exception\UnavailableForLegalReasonsException;
 ...
 */
class verystreamClient
{
    const API_BASE_URL = 'https://api.verystream.com';
    const API_VERSION  = 1;
